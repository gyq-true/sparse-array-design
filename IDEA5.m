...
%大规模版本
% =============================================================
% 加入阵元扰动后：10轮优化到290个，半功率波束宽度为4.7043度
% =============================================================
%是迭代次数设置有问题？
% =============================================================
clear; clc; close all;
...
%     end
    ...
    active_count_new = sum(active_mask);
...
pattern_u = 20*log10(abs(A_u_slice * c)/max(abs(A_u_slice * c)));u_axis
...
%% 分别计算3dB波束宽度
[hpbwsparse_u] = calculate_hpbw(slice_axis, pattern_u);
[hpbwsparse_v] = calculate_hpbw(slice_axis, pattern_v);
