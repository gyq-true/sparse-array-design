function [U_dB_taylor,U_dB_ChebyShev] =  full_array_with_windows_aftersamesidelobe_u(N_side,k,Space,max_sll_val,Axis_scale)
% u轴满阵加窗（泰勒窗 切比雪夫窗）在相同旁瓣电平下比较主瓣宽度
% =============================================================
%阵元坐标设置
...
%各种窗
%泰勒窗
win_1d = taylorwin(N_side, 5, max_sll_val);    
win_2d = win_1d * win_1d';        
w_full_taylor = win_2d(:);        
%切比雪夫窗
win_c = chebwin(N_side, abs(max_sll_val));
w_cheby = (win_c * win_c.');
w_cheby = w_cheby(:);
%生成方向图
